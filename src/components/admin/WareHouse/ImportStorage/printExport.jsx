...
import { exportPrintSelector, importPrintSelector } from '../../../../redux/selectors';
import { formatDate } from '../../../../utils/formatDate';
import TableLayout from '../../../commons/Layouts/Table';
import './style.css';
import { setExportPrint, setImportPrint } from '../../../../redux/reducer/warehouse/warehouse.reducer';
export function PrintExport(props) {
  const contentPrint = useSelector(exportPrintSelector);
        ...
        <div className="row justify-content-center">
          <div className="mt-1 p-3  container w-100">
            ...
            <div ref={components} className="print-style">
              <h1 className="mt-2 mb-4 font-30px fw-bold text-center ">Delivery Bill</h1>
              <div className="d-flex flex-column">
                <div className=" row container">
                  ...
                  <div className="col-4 total_order_detail">
                    ...
                    <h4 className="fs-6  mt-4 mb-1 font-weight-bold ">
                      Amount : <span>{contentPrint.export_amount}</span>
                    </h4>
                    <h4 className="fs-6  mt-4 mb-1 font-weight-bold ">
